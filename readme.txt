...
2.5.	You can run ContinuityCheck.py on the resulting folder to check if there's a frame without any detected object
	format of the output: ['filename', numberOfEmptyFrames, listOfEmptyFrames
...
If this is confusing for you, well, me too.
